...
public class MyPterHeader extends FrameLayout implements PtrUIHandler {
    ...
    public MyPterHeader(Context context) {
        super(context);
        init();
    }

    public MyPterHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MyPterHeader(Context context, AttributeSet attrs, int defStyleAttr) {

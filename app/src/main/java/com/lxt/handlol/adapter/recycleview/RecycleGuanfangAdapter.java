...
public class RecycleGuanfangAdapter extends RecyclerView.Adapter<RecycleGuanfangAdapter.ItemContentViewHolder> {

    private Context context;
    private List<GuanFangBean.BodyBean> listBeen;
    private boolean isVideo = false;

    public RecycleGuanfangAdapter(Context context, List<GuanFangBean.BodyBean> listBeen) {
    ...
    public void onBindViewHolder(ItemContentViewHolder holder, int position) {
        final GuanFangBean.BodyBean bean = listBeen.get(position);
        ...
        if (article_url.contains("iVideoId=")) {
            //这是一个视屏
        ...
        itemContentViewHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //跳转到详情界面
                if (bean.getArticle_url().contains("iVideoId=")) {
                    LogUtil.e("这是视屏");
    ...
    public void updateData(List<GuanFangBean.BodyBean> listBeen) {
        this.listBeen = listBeen;
        notifyDataSetChanged();
    }

    public void addData(List<GuanFangBean.BodyBean> listBeen) {
